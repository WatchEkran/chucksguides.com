...
Viewer.prototype = {
  ...
  load_page: function (idx, pages_to_preload, callback) {
    ...
    if (url) {
      ...
      // load data
      {
        ...
        xhr.open(
          'GET',
          `https://assets.chucksguides.com/aircraft/dcs/fa-18c/f0bed2b7bc5d2c26628cfe1245d0bc57/${url}`,
          true
        )
        xhr.onload = function () {
  ...
  update_page_idx: function () {
    ...
    for (var i = last_idx; i < pages_len; ++i) {
      ...
      var page_visible_ratio =
        (Math.min(container_max_y, page_max_y) - Math.max(container_min_y, page_min_y)) / page_height
  ...
  rescale: function (ratio, is_relative, fixed_point) {
    ...
    container.scrollLeft +=
      (fp_x_inside / old_scale) * new_scale + fp_p.offsetLeft + fp_p.clientLeft - fp_x_inside - fp_x_ref
    container.scrollTop +=
      (fp_y_inside / old_scale) * new_scale + fp_p.offsetTop + fp_p.clientTop - fp_y_inside - fp_y_ref
